...
import com.kenshi.composetodoapp.components.PriorityItem
import com.kenshi.composetodoapp.data.models.Priority
import com.kenshi.composetodoapp.ui.theme.*
...
//                    sharedViewModel.searchTextState = newText
...
fun SortAction(
    ...
    // expanded 변수의 상태를 유지 하기 위함
    // 기본적으로는 확장 되지 않음
    // 변수의 값이 변경 될 때마다 드롭 다운이 즉시 update
